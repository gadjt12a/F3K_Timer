---
name: flash-firmware
description: Build and upload firmware to the ESP32 timer device. Use when the user asks to "flash the timer", "flash firmware", "upload to the device", or after making changes to firmware source files.
